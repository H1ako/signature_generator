...
<main class="main-content">
  ...
  <section class="main-content__editor">
    <h2 class="editor__heading" go-for-more-signatures-anchor><?= $localeReader->translate('Create your own <b>Signature</b>'); ?></h2>
  ...
  <section class="main-content__instruction" itemscope="" itemtype="http://schema.org/Article">
    ...
    <meta itemprop="image" content="<?= $SITE_URL ?>/assets/images/<?= $localeReader->translate('Step Image 1'); ?>">
      ...
      <ul class="block__steps" itemscope itemtype="http://schema.org/ItemList">
        <li class="steps__step" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
          ...
          <div class="step__right">
            <img itemprop="image" src="<?= $SITE_URL ?>/assets/images/<?= $localeReader->translate('Step Image 1'); ?>" width="300" height="300" title="<?= $localeReader->translate('Step Image Title 1'); ?>" alt="<?= $localeReader->translate('Step Image Title 1'); ?>" class="right__img">
          </div>
        </li>
        <li class="steps__step" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
          <div class="step__left">
          ...
          <div class="step__right">
            <img itemprop="image" src="<?= $SITE_URL ?>/assets/images/<?= $localeReader->translate('Step Image 2'); ?>" width="300" height="300" title="<?= $localeReader->translate('Step Image Title 2'); ?>" alt="<?= $localeReader->translate('Step Image Title 2'); ?>" class="right__img">
          </div>
        </li>
        <li class="steps__step" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
          <div class="step__left">
          ...
          <div class="step__right">
            <img itemprop="image" src="<?= $SITE_URL ?>/assets/images/<?= $localeReader->translate('Step Image 3'); ?>" width="300" height="300" title="<?= $localeReader->translate('Step Image Title 3'); ?>" alt="<?= $localeReader->translate('Step Image Title 3'); ?>" class="right__img">
          </div>
        </li>
        <li class="steps__step" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
          <div class="step__left">
          ...
          <div class="step__right">
            <img itemprop="image" src="<?= $SITE_URL ?>/assets/images/<?= $localeReader->translate('Step Image 4'); ?>" width="300" height="300" title="<?= $localeReader->translate('Step Image Title 4'); ?>" alt="<?= $localeReader->translate('Step Image Title 4'); ?>" class="right__img">
          </div>
        </li>
        <li class="steps__step" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
          <div class="step__left">
          ...
          <div class="step__right">
            <img itemprop="image" src="<?= $SITE_URL ?>/assets/images/<?= $localeReader->translate('Step Image 5'); ?>" width="300" height="300" title="<?= $localeReader->translate('Step Image Title 5'); ?>" alt="<?= $localeReader->translate('Step Image Title 5'); ?>" class="right__img">
          </div>
        </li>
        <li class="steps__step" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
          <div class="step__left">
          ...
          <div class="step__right">
            <img itemprop="image" src="<?= $SITE_URL ?>/assets/images/<?= $localeReader->translate('Step Image 6'); ?>" width="300" height="300" title="<?= $localeReader->translate('Step Image Title 6'); ?>" alt="<?= $localeReader->translate('Step Image Title 6'); ?>" class="right__img">
          </div>
        </li>
        <li class="steps__step" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
          <div class="step__left">
          ...
          <div class="step__right">
            <img itemprop="image" src="<?= $SITE_URL ?>/assets/images/<?= $localeReader->translate('Step Image 7'); ?>" width="300" height="300" title="<?= $localeReader->translate('Step Image Title 7'); ?>" alt="<?= $localeReader->translate('Step Image Title 7'); ?>" class="right__img">
          </div>
        </li>
      </ul>
    </div>
